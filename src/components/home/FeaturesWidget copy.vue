...
<template>
  <div id="features" class="py-6 px-2 lg:px-6 mt-20 mx-0 lg:mx-4 relative">
    <Carousel
      :value="products"
      :numVisible="3"
      :numScroll="1"
    ...
    >
      <template #item="slotProps">
        ...
        <div class="carousel-item dark:border-surface-700 rounded m-2">
          <div class="item-container">
              ...
              <div class="img-container mx-auto">
                ...
                <Tag
                    :value="slotProps.data.propertyStatus"
                    :severity="slotProps.data.inventoryStatus === 'INSTOCK' ? 'success' : slotProps.data.inventoryStatus === 'LOWSTOCK' ? 'warn' : 'danger'"
                    class="item-tag absolute"
                    style="right: 5px; top: 5px"
                  />  
                <div class="item-body w-100 item-price">
                  <div class="font-semibold text-xl">${{ slotProps.data.price }}</div>
                </div>
