...
import { Column, DataTable, IconField, InputIcon, InputText, Tag } from 'primevue'
...
const filteredProducts = ref<{ name: string; category: string; price: number; status: string }[]>(
  [],
)
